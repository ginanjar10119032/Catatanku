...
import com.ginanjartg.catatanku.viewpager.ViewPagerPertama;
import com.ginanjartg.catatanku.viewpager.ViewPagerKedua;
...
public class InfoFragment extends Fragment {
    ...
    private class SlideScreenPageAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0:
                    return new ViewPagerPertama();
                case 1:
                    return new ViewPagerKedua();
                default:
                    return null;
            }
        }
